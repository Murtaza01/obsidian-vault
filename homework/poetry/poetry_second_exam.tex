...
The poet uses a metaphor to tell his beloved that we should departure like virtuous
people when facing death; quietly and peacefully. \textbf{Simile} is used in \textit{"
As virtuous men"} to compare the parting of the lovers to the peaceful death of 
virtuous men.
...
The poet uses \textbf{metaphysical conceit} to compare separation in physical love and spiritual one.
In physical love separation is like an earthquack, it causes harm and fear. While in spiritual 
love separation is like planets and stars crashing, even though their damage is great, it goes
unnoticed by us.
...
to compare between the legs of a compass to two lovers.
...
In this poem John uses \underLine{metaphysical conceit} to compare between two types 
of love: spiritual love and physical love. He tells his beloved that physical 
...
\begin{itemize}
  \item \textbf{First stanza}: Their separation is quite and peaceful. Comparing  it to virtuous men leaving the world 
    using \textbf{simile} (\textit{"As virtuous men pass mildly"}).
  ...
  \item \textbf {Sixth stanza}: Separation strengthen their love and it cannot be broken. Comparing their love 
    to gold using \textbf{simile} (\textit{"Like gold to airy thinness beat"}). When gold is hammered it expand and remains unbroken.
...
The poet uses \textbf{Apostrophe}\footnote{\, a figure of speech that addresses something or someone that cannot respond.}
...
pleasure. That righteous and good people die early, and it is nothing but the 
release of soul and the rest of the body.
...
and the after life. \textbf{Paradox} is used in \textit{"death, thou shalt die"}.
...
This poem is the tenth poem (also called \textit{"Sonnet X"}) of Donne's 
...
philosophy which asserts that the soul existed before this life. \textbf{Metaphysical conceit}
in \textit{"second race"} to compare life to a race.
...
\textbf{Metaphysical conceit} is used to compare physical distant to spiritual
one.
...
to its divine place and eternal from. \textbf{Metaphor/Metonymy}\footnote{\,
here its both metaphor and metonymy, both are correct.} in \textit{"dust"} 
...
In this poem Henry lament a time where he was once pure, innocent and close to God.
Those times were his childhood and the life before. Being older he begun to sin
and walk away from God's path. He longs for divine closeness.
...
came and changed his natural shape. \textbf{Metaphysical conceit} 
is used to compare between \textit{"architects"} to the soul
and \textit{"Green trees"} to the body.
...
struggle between physical desire and spiritual needs}. 
