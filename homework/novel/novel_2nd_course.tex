...
\newgeometry{top=0.5in,bottom=0.8in}
...
Hill picnic, and then she is scolded by Mr. Knightley. 
She realizes she is in love with him after being jealous of Harriet’s 
feelings for Mr. Knightley. 
...
\subheadfoot{Less Important Quotes}{\, these quotes are seen in the 'Abridged Notes' 
and are less likey to be in the first and second exam, they only matter in the final exam.}
...
\subheadfootb{Chapter 1-10}{\, first exam question.}
...
\phantomsection
\section*{\centering{\fontsub{\large Fill in the Blank}}}
\addcontentsline{toc}{section}{Fill in the Blank}
